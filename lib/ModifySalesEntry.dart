...
// (Item Rate / Manual) an item's rate came from.
...
_itemController.text = _selecteditem;
  ...
  Future<void> generateInvoicePDF(
    ...
    // updated invoice there's nothing left to edit here, so go to the view
    ...
    // focused while its controller was cleared, which reopened its
                      ...
                      ElevatedButton.icon(
                        onPressed: () {
                          ...
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                              builder: (context) => PendingSalesEntry(),
                            ),
                          );
                        },
                        icon: const Icon(
                            ...
                            Padding(
                              ...
                              child: DropdownButtonFormField<String>(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  labelText:
                                      "Voucher Type", // 👈 This makes it a heading
                                  labelStyle: GoogleFonts.poppins(
                                    fontSize: 13,
                                    color: Theme.of(
                                      context,
                            ...
                            Padding(
                              ...
                              child: DropdownButtonFormField<String>(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  labelText:
                                      "Sales Ledger", // 👈 This makes it a heading
                                  labelStyle: GoogleFonts.poppins(
                                    fontSize: 13,
                                    color: Theme.of(
                                      context,
